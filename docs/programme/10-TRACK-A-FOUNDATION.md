...
| ID | Phase | Repos | Depends | Deliverable | Exit | Status |
| :- | :---- | :---- | :------ | :---------- | :--- | :----- |
| **A13** | Alert routing and on-call proof | infra, workspace | — | SLO breaches route to a real destination; `INCIDENT-RESPONSE.md` rehearsed. Closes the open half of R8 | A synthetic SLO breach produces a delivered alert. A rehearsal is logged with time-to-detect | WIP |
