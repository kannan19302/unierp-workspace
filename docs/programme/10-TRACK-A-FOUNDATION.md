...
| **A22** | Backup and restore, rehearsed | infra, data, workspace | — | A restore performed from a real backup into a clean environment, timed and logged | A full restore rehearsal is logged with measured RTO and RPO. `verify-backup.mjs` runs on a schedule and fails loudly (**G-11**) | WIP |
