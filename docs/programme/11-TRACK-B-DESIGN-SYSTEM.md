...
| **B03** | Feedback — `Toast`, `Alert`, `Banner`, `InlineMessage`, `Progress`, `ProgressCircle`, `LoadingOverlay` | A02 | One notification surface; queueing, deduplication, and a live region | Toasts are announced by a screen reader, dedupe under a burst of 50, never trap focus, and are dismissible by keyboard | WIP |
