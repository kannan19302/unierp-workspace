...
| **B19** | Flutter component library at parity | B18, B01–B09 | The B01–B09 primitives implemented in Flutter against generated tokens | A screen described by the same schema renders equivalently on web and mobile. Parity is asserted by a checklist gate, not by eye | WIP |
