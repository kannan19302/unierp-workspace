...
| **C09** | Impersonation audit and review | C08 | Every impersonated action attributed to *both* the staff member and the tenant user; a reviewable session transcript | A tenant admin can see every impersonation session against their tenant, including what was done. Nothing is invisible to them | DONE |
