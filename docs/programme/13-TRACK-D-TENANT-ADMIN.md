...
| **D04** | Organisation structure | D03 | Legal entities, business units, branches, teams, cost centres, approval hierarchies — the structure the whole ERP hangs off | An approval routes correctly through a three-level hierarchy with a vacant position handled by escalation, not by silence | WIP |
