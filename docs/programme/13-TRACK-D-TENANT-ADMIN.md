...
| **D10** | Complete tenant export | D01 | Full export of every entity a tenant owns, in a documented, re-importable format, including attachments and audit history | The export re-imports into a clean instance and reconciles record-for-record. Requested by the tenant, delivered without our involvement | WIP |
