...
| **D02** | User lifecycle | D01, A21 | Invite, onboard, activate, suspend, transfer ownership, offboard — with bulk operations, CSV import, and directory-independent operation | An offboarded user's sessions are revoked, their records reassigned, and their access removed everywhere within one operation. Reassignment leaves no orphaned approvals | WIP |
