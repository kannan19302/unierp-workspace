...
| ID | Phase | Modules | Depends | Non-negotiables at exit | Status |
| :- | :---- | :------ | :------ | :---------------------- | :----- |
| **E27** | Content, documents and storage | `documents`, `drive`, `storage` | E04 | Versioning, permissions, retention (D12), preview, full-text search, quota, virus scanning, and attachment lifecycle tied to records | WIP |
