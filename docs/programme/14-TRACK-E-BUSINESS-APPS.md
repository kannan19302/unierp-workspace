...
| **E21** | Payroll and compensation | `advanced-hr`, `hr-advanced` | E20, E09, E12 | Statutory-correct payroll per jurisdiction, retro-pay, arrears, payslips, GL posting, and a **100 %**-covered calculation engine. Consolidates the two overlapping advanced-HR modules into one | WIP |
