...
| **E34** | Standard report library | E33 | The reports each module is expected to have — statutory, operational, management — as governed definitions | Every module's expected report set exists and reconciles to its source data | WIP |
