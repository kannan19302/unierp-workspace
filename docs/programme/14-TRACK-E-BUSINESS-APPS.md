...
| **E41** | Localisation completeness | E12, B06 | Every user-facing string externalised; RTL; locale-correct dates, numbers, currency, address formats and name ordering; timezone correctness throughout | A hardcoded user-facing string fails CI. The platform is fully usable in an RTL locale (**G-15**) | WIP |
