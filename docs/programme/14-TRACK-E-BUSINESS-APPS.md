...
| **E35** | Ad-hoc report builder | E33, B01 | End-user report building on the semantic layer: fields, filters, grouping, totals, drill-through, save, share | A tenant user builds a cross-module report without SQL, and it respects their permissions, not the author's | WIP |
