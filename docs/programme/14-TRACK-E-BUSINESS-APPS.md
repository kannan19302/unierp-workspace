...
| **E38** | Analytics warehouse and history | E33 | Historical and aggregate store so analytical load does not sit on the transactional database | A year-over-year query does not degrade transactional p95. Verified under load | WIP |
