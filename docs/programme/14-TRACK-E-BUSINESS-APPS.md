...
| **E36** | Scheduled delivery and subscriptions | E34, A21 | Reports scheduled, filtered per recipient, delivered by any channel, with failures visible | A scheduled report delivers to 100 recipients with per-recipient permission filtering applied | WIP |
