...
| **E39** | Federated search | E27, B04 | Permission-filtered search across every entity: typo-tolerant, entity-aware, ranked, with actions from results | Searching a term returns only records the user may see — and result *counts* do not leak the existence of others (**G-6**) | WIP |
