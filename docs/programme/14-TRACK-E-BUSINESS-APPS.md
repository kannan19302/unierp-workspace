...
| **E07** | Bulk operations framework | E04, B01, B11 | Bulk edit, delete, approve, assign, export, duplicate and merge — with preview, partial-failure reporting, progress and undo where feasible | A 10,000-row bulk edit reports per-row outcomes, does not time out, and does not lock the table for other tenants | WIP |
