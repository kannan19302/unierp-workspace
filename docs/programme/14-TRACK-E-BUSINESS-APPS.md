...
| **E37** | Dashboards for end users | E33, B10 | Tenant-authored dashboards from governed metrics, with drill-through to records | A dashboard tile drills through to the filtered record list that produced it | WIP |
