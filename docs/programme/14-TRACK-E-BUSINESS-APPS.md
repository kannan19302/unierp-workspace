...
| **E40** | Command palette and quick actions | E39, B04 | One keyboard entry point to any record, route or action in the platform | Any record is reachable in under three keystrokes plus a query, from any screen | WIP |
