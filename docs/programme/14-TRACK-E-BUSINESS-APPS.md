...
| **E10** | Receivables, payables and cash | `finance` | E09 | Ageing, dunning, allocation, part-payment, write-off, bank reconciliation; every posting traceable to a source document | WIP |
