...
| **G10** | Form builder and editor | G09, B05, D14 | The 9-line `forms/[id]` stub replaced by a real editor: layout, conditional visibility, validation, multi-step, dependent pickers, draft/resume | A 40-field multi-step form with conditional logic is built visually and renders identically on web, mobile and desktop | WIP |
