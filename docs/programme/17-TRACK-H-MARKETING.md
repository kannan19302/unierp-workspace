...
| **H05** | Pricing, plans and comparison | H02, C13 | Pricing page driven by the **same plan definitions the platform bills from**, so published prices cannot drift from what is charged | A plan change in C13 updates the pricing page without an edit. A mismatch fails CI | WIP |
