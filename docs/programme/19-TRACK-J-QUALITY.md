...
| **J12** | State-machine and lifecycle testing | E06 | Exhaustive transition testing per entity lifecycle, including every forbidden transition | Every forbidden transition is proven to be rejected. A new state added without tests fails CI | WIP |
