...
| **J25** | Backup, restore and DR rehearsal | A22, A23 | Scheduled rehearsal of full restore and per-tenant PITR, with measured RPO/RTO published | RPO and RTO are committed numbers proven by rehearsal, and the rehearsal is on a schedule that fails loudly if skipped (**G-11**) | WIP |
