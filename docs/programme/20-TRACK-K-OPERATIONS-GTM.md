...
| **K15** | Data portability and exit rights | D10, C24 | A contractual, tested exit path: complete export, assisted migration away, deletion certificate — the honest counterpart to the self-hosting promise | A tenant exits fully unaided and receives a deletion certificate. Verified by rehearsal, not by clause (**G-4**) | WIP |
