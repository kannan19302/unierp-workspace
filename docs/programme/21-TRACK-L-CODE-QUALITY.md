...
| **L06** | Duplication gate | A02 | Copy-paste detection with a threshold, tuned to flag genuine duplication rather than incidental similarity | Duplicating a 40-line block across modules fails CI. Baseline recorded and ratcheted. High-duplication clusters become L07–L10 work items | WIP |
