...
| **L02** | Naming convention gate | A02 | `@typescript-eslint/naming-convention` encoding `CODE_STANDARDS § 3` | A violation of the documented naming scheme fails CI on a new or modified file. Baseline recorded | WIP |
