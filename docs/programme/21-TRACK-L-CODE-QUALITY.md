...
| **L18** | Generated architecture and dependency maps | A07, L05 | Machine-generated, always-current maps: repo layer graph, module dependency graph, event flow, permission matrix | Each map regenerates in CI and a stale committed copy fails the build. This replaces prose that describes structure — the class of claim that produced D004 and D013 | WIP |
