...
| ID      | Phase                                        | Depends            | Deliverable                                                                                                                                                                       | Exit                                                                                                                                                                                                                                                     | Status |
| :------ | :------------------------------------------- | :----------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----- |
| **M25** | Provider billing and cost ingestion           | M16, M04           | Scheduled ingestion of every provider's billing export, normalised to one cost model, with currency, amortisation, credits, commitments and late-arriving adjustments             | An ingested month reconciles to the provider's own invoice total to the cent. Money is `Decimal(19,4)` throughout; a `Float` in this path fails the build. Re-ingesting the same period does not double-count — asserted                                  | OPEN   |
