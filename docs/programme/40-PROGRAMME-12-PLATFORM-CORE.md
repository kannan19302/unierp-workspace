...
| **P12-034** | Migration safety analysis | P12-033 | Classifying every migration by lock risk, data risk and reversibility before it runs | A locking migration on a large table is refused without an online strategy | WIP |
