...
| **P12-052** | Multi-tenant data isolation proof | P12-028 | An isolation test for every table in the schema, generated rather than written by hand | Every table has an isolation test proving **zero** cross-tenant rows. A new table without one fails CI | WIP |
