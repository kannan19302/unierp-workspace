...
| **P12-048** | The outbox | P12-040 | The transactional outbox every cross-module effect goes through | An event and its causing write commit atomically. Killing the process between them is proven impossible | WIP |
