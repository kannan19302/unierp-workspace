...
| **P12-069** | API versioning strategy | P12-010 | The declared versioning model — how a version is expressed, supported and retired | A version retired inside its support window is refused, enforced mechanically | WIP |
