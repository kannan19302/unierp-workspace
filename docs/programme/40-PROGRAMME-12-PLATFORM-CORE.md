...
| **P12-050** | Event delivery and ordering | P12-049 | Delivery guarantees, ordering, retry and dead-letter for the outbox | A redelivered event produces no duplicate effect. A subscriber offline for an hour loses nothing | WIP |
