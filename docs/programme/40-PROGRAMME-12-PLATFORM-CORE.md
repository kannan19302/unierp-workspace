...
| **P12-072** | Consumer-driven contract tests | P12-007 | Every consumer's expectations expressed as tests the provider runs | A provider change breaking a consumer fails in the provider's CI, not the consumer's | WIP |
