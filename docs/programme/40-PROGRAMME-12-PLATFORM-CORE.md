...
| **P12-090** | Stage C contract proof | P12-085 | A suite asserting generation determinism, compatibility classification, consumer enumeration and deprecation enforcement | All four hold, and each fails when its mechanism is deliberately removed | WIP |
