...
| **P12-073** | Contract documentation generation | P12-023 | API reference generated from contracts for every consuming audience | Documentation regenerates from contracts; drift fails CI | WIP |
