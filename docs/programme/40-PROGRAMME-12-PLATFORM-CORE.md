...
| **P12-038** | Query safety | P12-037 | Parameterisation throughout, with raw SQL confined to reviewed, parameterised helpers | String-concatenated SQL fails a lint gate, proven on a seeded example | WIP |
