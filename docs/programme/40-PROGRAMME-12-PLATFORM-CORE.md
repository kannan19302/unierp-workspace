...
| **P12-007** | Consumer registry | P12-006 | The EP-3 mechanism: for any published artefact, the complete list of consumers across all twelve programmes | "Who uses this?" is answerable by command for every exported symbol, contract and event | WIP |
