...
| **P12-081** | The single-source proof | P12-061 | The EP-1 mechanism: every client, type, SDK method and document derived from the contracts, with nothing hand-maintained | A hand-maintained duplicate of any contract-derived artefact is detected and fails CI | WIP |
