...
| **P12-060** | Contract validation at runtime | P12-059 | Services validating requests and responses against their own contracts | A response diverging from its contract fails in test and is caught before release | WIP |
