...
| **P12-021** | Dead code and unused export removal | P12-002 | Removing what the census finds unreachable across the claimed repositories | Unreachable code is removed or justified. `check-orphaned-exports.mjs` is clean | WIP |
