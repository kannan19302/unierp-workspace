...
| **P12-089** | Contract registry and discovery | P12-057 | A queryable registry of every contract, version, consumer and deprecation state | Any contract's state and consumers are answerable by command | WIP |
