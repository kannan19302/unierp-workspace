...
| **P12-029** | RLS verification against runtime DDL | P12-028 | Verifying policies on tables created at runtime, not only those in the schema file | Runtime-created tables are covered — closing **D143** for `co_*` and `ext_*` tables | WIP |
