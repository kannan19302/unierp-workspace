...
| **P12-002** | The unowned-code census | P12-001 | Every claimed repository measured: what it does, what is reachable, what is tested, what is dead, what other repositories import from it | The census is reproducible by command and published as data. Every repository has a measured profile | WIP |
