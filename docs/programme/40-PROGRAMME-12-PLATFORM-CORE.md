...
| **P12-071** | Deprecation mechanism | P12-070 | Marking, signalling and enforcing deprecation windows on contract elements | A deprecated element still works and warns; removal inside its window is refused | WIP |
