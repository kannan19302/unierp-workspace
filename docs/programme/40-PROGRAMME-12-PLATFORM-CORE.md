...
| **P12-079** | Extension API contract | P12-056 | `unierp-extension-api` as the versioned contract extensions implement | An extension built against an older contract version continues to work within its window | WIP |
