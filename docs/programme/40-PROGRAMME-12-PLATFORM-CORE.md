...
| **P12-033** | Migration discipline | P12-025 | Forward-only migrations, immutable once shipped, with tested rollback | Replaying every migration from empty reproduces the schema exactly. Editing a shipped migration fails CI | WIP |
