...
| **P12-020** | Stricter quality gates for shipped libraries | P12-008 | The EP-7 mechanism: higher coverage, stricter lint and public-API documentation requirements than application code | A library below the library threshold fails, even where an application would pass | WIP |
