...
| **P12-085** | The compatibility proof | P12-070 | The EP-2 mechanism: a corpus of compatible and breaking changes, each classified correctly | Every change in the corpus is classified correctly, and a misclassification is caught | WIP |
