...
| **P12-053** | Schema change impact analysis | P12-007 | Before a schema change, the complete list of affected services, queries and generated clients | A change breaking a consumer is reported before it lands, naming the consumer | WIP |
