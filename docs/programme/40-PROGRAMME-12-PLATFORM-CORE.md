...
| **P12-042** | Schema decomposition | P12-031 | The EP-6 mechanism: `core.prisma` split so no `.prisma` file exceeds the stated ceiling — closing **D001** | No `.prisma` file exceeds 3,000 lines, enforced by `check-schema-size.mjs`. The generated client is identical before and after, verified by comparison | WIP |
