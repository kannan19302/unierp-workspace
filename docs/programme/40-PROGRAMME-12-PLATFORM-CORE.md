...
| **P12-058** | Contract coverage of the API surface | P12-057 | Every endpoint across all services represented in the contracts | An endpoint absent from the contracts fails a gate, proven on a seeded endpoint | WIP |
