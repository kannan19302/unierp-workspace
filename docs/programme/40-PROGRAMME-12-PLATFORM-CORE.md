...
| **P12-015** | Error taxonomy for the platform core | P12-014 | The shared error hierarchy every service and consumer maps to | Every thrown error carries a registry code. An uncoded error fails `check-error-handling.mjs` | WIP |
