...
| **P12-095** | Validation primitives | P12-059 | One validation approach used by every service, aligned with the contracts | A service using a second validation approach fails an architecture gate | WIP |
