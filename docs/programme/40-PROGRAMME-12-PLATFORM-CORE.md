...
| **P12-082** | Contract performance implications | P12-065 | Contract shapes that do not force N+1 access or over-fetching on consumers | An endpoint forcing a waterfall on a documented consumer journey is reported | WIP |
