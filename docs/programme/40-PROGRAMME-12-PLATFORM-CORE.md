...
| **P12-046** | Retention primitives | P12-044 | Shared retention execution, legal hold and purge used by every module | A module implementing its own retention fails an architecture gate | WIP |
