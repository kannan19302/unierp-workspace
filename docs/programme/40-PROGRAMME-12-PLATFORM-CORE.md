...
| **P12-012** | Dependency governance | P12-008 | Allowlisted dependencies with size, licence, maintenance and vulnerability policy across 21 repositories | An unvetted or vulnerable dependency fails the build with its advisory named | WIP |
