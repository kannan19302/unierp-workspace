...
| **P12-010** | Versioning policy | P12-003 | Semantic versioning across all published packages, derived from the actual diff | A breaking change published as a minor version is refused, with the breaking symbol named | WIP |
