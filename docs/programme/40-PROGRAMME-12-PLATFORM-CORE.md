...
| ID | Phase | Depends | Deliverable | Exit | Status |
| :- | :---- | :------ | :---------- | :--- | :----- |
| **P12-091** | Shared library boundaries | P12-006 | What belongs in `unierp-shared` versus a service, with the rule enforced | A service-specific utility in the shared library fails a gate, and vice versa | WIP |
