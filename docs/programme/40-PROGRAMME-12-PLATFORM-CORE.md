...
| **P12-074** | SDK architecture | P12-062 | `unierp-sdk` as the supported public interface, layered over the generated client | An SDK capability absent from the contracts fails the parity test | WIP |
