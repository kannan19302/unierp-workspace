...
| **P12-040** | Transaction and isolation standard | P12-037 | Declared transaction boundaries and isolation levels used consistently across services | A concurrent conflict produces a documented, retryable error rather than a lost update | WIP |
