...
| **P12-011** | Release and changelog automation | P12-010 | Mechanical version bumps and changelogs generated from the change set | A release's notes derive from its diff and cannot be hand-written, verified by generation | WIP |
