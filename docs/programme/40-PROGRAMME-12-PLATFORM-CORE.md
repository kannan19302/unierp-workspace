...
| **P12-066** | Error response convention | P12-015 | One error shape across every endpoint, carrying the registry code | An off-convention error response fails a gate, proven on a seeded endpoint | WIP |
