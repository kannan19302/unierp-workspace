...
| **P12-035** | Online schema change | P12-034 | Adding and altering columns without blocking traffic on large tables | A column is added to a 10-million-row table with no write blocked beyond the stated threshold, measured | WIP |
