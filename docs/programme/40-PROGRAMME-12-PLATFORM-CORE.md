...
| **P12-009** | Cross-repository CI | P12-008 | CI that builds a change against every dependent repository, not only its own | A change breaking a dependent is caught in that change's CI, not in the dependent's later | WIP |
