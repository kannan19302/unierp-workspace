...
| **P12-043** | Schema lint rules | P12-031 | Automated schema review: missing indexes, nullable foreign keys, unbounded strings, missing cascades | Each lint rule fires on a seeded violation and is silent on a clean schema | WIP |
