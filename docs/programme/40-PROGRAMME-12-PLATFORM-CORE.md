...
| **P12-019** | Repository hygiene | P12-008 | Consistent structure, licensing, contribution rules and no stray artefacts across 21 repositories | A committed evidence file or stray document at a repository root fails CI — the **D145** shape | WIP |
