...
| **P12-062** | TypeScript client and types | P12-061 | The generated TypeScript client used by web, developer portal, console and sites | A contract change producing an incompatible call fails the consumer's build | WIP |
