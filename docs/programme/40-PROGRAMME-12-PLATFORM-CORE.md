...
| **P12-006** | Repository dependency graph | P12-002 | The real graph of which repository imports what from which, generated from source | The graph is generated, not maintained. A cycle between repositories fails the gate | WIP |
