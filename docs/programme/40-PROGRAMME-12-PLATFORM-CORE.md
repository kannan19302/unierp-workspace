...
| **P12-017** | Observability standard | P12-014 | Metric, trace and log conventions every service implements identically | A service emitting off-standard telemetry fails a gate | WIP |
