...
| **P12-018** | Health and readiness contract | P12-017 | A uniform health and readiness interface across every service | Every service exposes the contract; one that does not fails the gate | WIP |
