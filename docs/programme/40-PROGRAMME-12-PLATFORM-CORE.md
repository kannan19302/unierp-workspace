...
| **P12-024** | Remediation backlog | P12-002 | The census and the sweep turned into a prioritised, tracked backlog routed to this programme's phases | Every measured defect class is routed to a phase; an unrouted class fails the gate | WIP |
