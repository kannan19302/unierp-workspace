...
| **P12-031** | Naming and modelling conventions | P12-026 | Enforced conventions for models, fields, relations, enums and indexes | A convention violation fails `check-naming-convention.mjs`, proven on a seeded example | WIP |
