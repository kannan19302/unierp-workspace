...
| **P12-055** | Stage B data proof | P12-052 | A property-based suite over generated schema states asserting isolation, integrity and migration reversibility | No invariant violation across generated states, and immediate detection when one is weakened | WIP |
