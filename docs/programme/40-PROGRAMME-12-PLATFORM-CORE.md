...
| **P12-030** | Money type discipline | P12-026 | `Decimal(19,4)` with explicit currency everywhere money appears in the schema | A `Float` in a money path fails CI. A bare amount without a currency does not typecheck | WIP |
