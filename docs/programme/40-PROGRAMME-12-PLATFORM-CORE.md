...
| **P12-028** | RLS policy generation | P12-027 | Policies generated from the model rather than hand-written per table | A hand-written policy diverging from its model is detected. Generation is idempotent | WIP |
