...
| **P12-005** | Runtime precondition gate | P12-001 | Startup and CI assertion of each external capability this programme consumes, with explicit degradation | With a capability absent, the dependent surface says exactly what is missing and no other surface is affected | WIP |
