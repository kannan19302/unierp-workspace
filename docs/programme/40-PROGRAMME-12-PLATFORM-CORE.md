...
| **P12-045** | Field-level encryption primitives | P12-044 | Shared encryption for classified fields, with key management and rotation | A field marked PII is unreadable in a database dump, verified by inspection | WIP |
