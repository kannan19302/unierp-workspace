...
| **P12-039** | Connection and pool management | P12-037 | Pooling, limits, timeouts and per-tenant fairness | Pool exhaustion by one tenant is prevented, proven under adversarial load | WIP |
