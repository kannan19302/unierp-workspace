...
| **P12-013** | Supply-chain integrity | P12-012 | SBOM, provenance attestation and signature verification for every published package | An unsigned or unattested package cannot be published or consumed, proven by test | WIP |
