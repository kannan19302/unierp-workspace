...
| **P12-059** | Request and response schema completeness | P12-058 | Full typed schemas including error shapes, not only success paths | A response shape absent from the contract fails a gate, including error responses | WIP |
