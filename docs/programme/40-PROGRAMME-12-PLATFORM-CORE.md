...
| **P12-003** | The breaking-change rule, declared and enforced | P12-002 | The § 0 rule made mechanical: contract, type, event and auth changes classified, versioned, and consumer-checked before landing | An unclassified change to a published artefact fails CI. The gate is proven to fail on a seeded breaking change | WIP |
