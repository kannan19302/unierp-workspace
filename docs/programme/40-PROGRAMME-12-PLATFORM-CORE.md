...
| **P12-076** | SDK versioning and compatibility | P12-069 | SDK versions mapped to API versions with a stated support matrix | An SDK used against an unsupported API version fails clearly, not obscurely | WIP |
