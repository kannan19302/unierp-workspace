...
| **P12-086** | Contract change impact reporting | P12-007 | Before a contract change lands, the enumerated list of affected consumers | The reported consumer set equals the actually affected set, verified differentially | WIP |
