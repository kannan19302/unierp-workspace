...
| **P12-083** | Contract security review | P12-059 | Every contract reviewed for over-exposure, mass assignment and enumeration risk | A contract exposing a field its permission model does not cover fails review | WIP |
