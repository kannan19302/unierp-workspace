...
| **P12-026** | Schema measurement | P12-025 | The real schema measured: models, fields, relations, indexes, file sizes, generated size | Every measurement is reproducible by command and tracked over time | WIP |
