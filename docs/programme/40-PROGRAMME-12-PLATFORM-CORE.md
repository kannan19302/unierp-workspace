...
| **P12-036** | Seed and fixture data | P12-033 | Deterministic seed data and the shared fixture set every programme's tests use | Two seed runs produce identical data. Every programme's tests can use the shared fixtures | WIP |
