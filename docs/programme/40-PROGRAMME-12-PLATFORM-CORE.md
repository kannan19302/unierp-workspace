...
| **P12-084** | Contract testing infrastructure | P12-072 | The harness consumers and providers both use for contract testing | A contract test is writable without new infrastructure, and the harness has its own tests | WIP |
