...
| **P12-047** | Audit primitives | P12-041 | Shared, append-only, immutable audit used by every module | Audit records cannot be updated or deleted by any application path, proven by test | WIP |
