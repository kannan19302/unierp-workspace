...
A **307-phase** execution plan to take UniERP from *"broad, architecturally sound, and now
...
| **In what order do the 307 remaining pieces of work happen, and how do I know one is done?** | **this folder** |
...
| 5 | [`10-TRACK-A-FOUNDATION.md`](10-TRACK-A-FOUNDATION.md) | **A01–A28** · Proof, packaging, release, CI/CD, tenancy correctness. The gate on everything. |
