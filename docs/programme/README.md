...
A **308-phase** execution plan to take UniERP from *"broad, architecturally sound, and now
...
| **In what order do the 308 remaining pieces of work happen, and how do I know one is done?** | **this folder** |
...
| 1 | [`00-BASELINE.md`](00-BASELINE.md) | Verified current state of all 30 repositories, with the command that proves each claim. Read this first. |
...
| 5 | [`10-TRACK-A-FOUNDATION.md`](10-TRACK-A-FOUNDATION.md) | **A01–A29** · Proof, packaging, release, CI/CD, tenancy correctness. The gate on everything. |
